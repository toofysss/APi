...
if (isset($_POST['domin']) && isset($_POST['date'])) {
    if ($conn) {
        ...
        $query = "SELECT (SELECT COUNT(*) FROM T_Tenders WHERE T_Tenders.Dscrp IS NOT NULL AND T_Tenders.State=1) AS table_length,
                    T_Tenders.id as id,  T_Tenders.Dscrp as TendersDscrp, T_Tenders.ExpiryDate as ExpiryDate, T_Tenders.CreationDate as CreationDate, P_TenderSpecialization.Dscrp as Specialization, 
                    ...
                    INNER JOIN P_TenderSpecialization ON P_TenderSpecialization.id = T_Tenders.SpecializationID
    ...
    $query = "SELECT T_Tenders.id as id, T_Tenders.Dscrp as TendersDscrp, T_Tenders.TendersDetails as TendersDetails, T_Tenders.CreationDate as CreationDate, 
                T_Tenders.ExpiryDate as ExpiryDate, P_TenderSpecialization.Dscrp as Specialization, T_Tenders.SpecializationID as SpecializationID, T_Tenders_Details.ItemDscrp as ItemDscrp,
